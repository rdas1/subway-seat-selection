...
database_url = os.getenv(
    "DATABASE_URL",
    "postgresql+asyncpg://postgres:postgres@postgres:5432/subway_seat_selection"
)
# Convert asyncpg URL to psycopg2 for Alembic (Alembic doesn't support asyncpg directly)
# Replace asyncpg with psycopg2 and update host if needed
database_url = database_url.replace("+asyncpg", "+psycopg2")
# If running in Docker, ensure host is correct (postgres service name)
if "@postgres:" in database_url or "@localhost:" in database_url:
    # Keep the host as is for Docker networking
    pass
